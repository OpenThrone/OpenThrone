...
describe('SpyService', () => {
  ...
  beforeEach(() => {
    ...
    attackerGenerator.addUnits(normUnits([
      { type: 'SPY' as UnitType, level: 1, quantity: 10, id: 1, isMercenary: false, userId: 1 },
      { type: 'SPY' as UnitType, level: 2, quantity: 10, id: 2, isMercenary: false, userId: 1 },
      { type: 'SPY' as UnitType, level: 3, quantity: 1000, id: 3, isMercenary: false, userId: 1 },
    ]));
    ...
    defenderGenerator.addUnits(normUnits([
      { type: 'SENTRY' as UnitType, level: 1, quantity: 5, id: 1, isMercenary: false, userId: 1 },
      { type: 'CITIZEN' as UnitType, level: 1, quantity: 200, id: 2, isMercenary: false, userId: 1 },
    ]));
  ...
  describe('simulateIntel', () => {
    ...
    it('fails when attacker.spy <= defender.sentry', () => {
      defenderGenerator.addUnits(normUnits([
        { type: 'SENTRY' as UnitType, level: 1, quantity: 100000, id: 1, isMercenary: false, userId: 1 },
      ]));
      defender = new UserModel(defenderGenerator.getUser());

...
const AttackService = require('../services/AttackService').default ?? require('../services/AttackService');
...
describe('Gold Pillage Fix - Attack Log Gold Recording', () => {
  ...
  test('should ensure BigInt gold conversion works correctly', () => {
    ...
    const newDefenseGold = BigInt(defensePlayerGold.toString()) - BigInt(pillagedGold.toString());
    const newAttackGold = BigInt(attackPlayerGold.toString()) + BigInt(pillagedGold.toString());
    ...
    const newLargeDefenseGold = BigInt(largeDefenseGold.toString()) - BigInt(largePillagedGold.toString());
    const newLargeAttackGold = BigInt(largeAttackGold.toString()) + BigInt(largePillagedGold.toString());

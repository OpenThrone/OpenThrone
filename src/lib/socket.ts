...
import { deposit, withdraw, getDepositHistory, getBankHistory } from '@/services/Bank.service';
import { UserDataService } from '@/services/UserDataService';
import { createSession, endSession, listSessions, validateSession, getSession, updateSessionActivity } from '@/services/Sessions.service';
import { performRecruitmentWithSessionValidation, getUserByRecruitLink, getRecruitmentRecords, getRandomAutoRecruitUser, getValidUsersForRecruitment } from '@/services/Recruitment.service';
import { MessagingService } from '@/services/Messaging.service';
import { trainUnits, untrainUnits, convertUnits } from '@/services/Training.service';
...
const handleConnection = (socket: Socket) => {
  ...
  socket.on('removeReaction', (data) => handleRemoveReaction(socket, userId, data));
  socket.on('markAsRead', (data) => handleMarkAsRead(socket, userId, data));
  socket.on('getChatRooms', () => handleGetChatRooms(socket, userId));
  socket.on('createChatRoom', (data) => handleCreateChatRoom(socket, userId, data));
  socket.on('getRoomMessages', (data) => handleGetRoomMessages(socket, userId, data));
  socket.on('addParticipants', (data) => handleAddParticipants(socket, userId, data));
  socket.on('manageParticipant', (data) => handleManageParticipant(socket, userId, data));
  socket.on('removeParticipant', (data) => handleRemoveParticipant(socket, userId, data));
  socket.on('searchMessages', (data) => handleSearchMessages(socket, userId, data));
  ...
  socket.on('manageStructureUpgrades', (data) => handleManageStructureUpgrades(socket, userId, data));
  socket.on('manageBattleUpgrades', (data) => handleManageBattleUpgrades(socket, userId, data));
  socket.on('createBlogPost', (data) => handleCreateBlogPost(socket, userId, data));
  socket.on('getBlogPosts', () => handleGetBlogPosts(socket, userId));
  socket.on('getRecentBlogPosts', () => handleGetRecentBlogPosts(socket, userId));
  socket.on('updateBlogReadStatus', (data) => handleUpdateBlogReadStatus(socket, userId, data));
  socket.on('getLatestUnreadBlogPost', () => handleGetLatestUnreadBlogPost(socket, userId));
  socket.on('getUserData', () => handleGetUserData(socket, userId));
  socket.on('searchUsers', (data) => handleSearchUsers(socket, userId, data));
  socket.on('checkDisplayName', (data) => handleCheckDisplayName(socket, userId, data));
  ...
  socket.on('getUserInfoByRecruitLink', (data) => handleGetUserInfoByRecruitLink(socket, userId, data));
  socket.on('updateBio', (data) => handleUpdateBio(socket, userId, data));
  socket.on('updateProfile', (data) => handleUpdateProfile(socket, userId, data));
  socket.on('changePassword', (data) => handleChangePassword(socket, userId, data));
  socket.on('updateSettings', (data) => handleUpdateSettings(socket, userId, data));
  ...
  socket.on('repairAccount', (data) => handleRepairAccount(socket, userId, data));
  ...
  socket.on('executeAttack', (data) => handleExecuteAttack(socket, userId, data));
  socket.on('getAttackLogs', (data) => handleGetAttackLogs(socket, userId, data));
  socket.on('getRecentAttacks', () => handleGetRecentAttacks(socket, userId));
  socket.on('grantAttackLogACL', (data) => handleGrantAttackLogACL(socket, userId, data));
  socket.on('battleTest', (data) => handleBattleTest(socket, userId, data));
  socket.on('fullScaleBattleTest', (data) => handleFullScaleBattleTest(socket, userId, data));
  ...
  socket.on('getBankHistory', (data) => handleGetBankHistory(socket, userId, data));
  ...
  socket.on('hireMercenary', (data) => handleHireMercenary(socket, userId, data));
  socket.on('dismissMercenary', (data) => handleDismissMercenary(socket, userId, data));
  ...
  socket.on('respondToFriendRequest', (data) => handleRespondToFriendRequest(socket, userId, data));
  socket.on('getFriends', () => handleGetFriends(socket, userId));
  socket.on('transferGold', (data) => handleTransferGold(socket, userId, data));
  socket.on('sendGoldRequest', (data) => handleSendGoldRequest(socket, userId, data));
  socket.on('respondToGoldRequest', (data) => handleRespondToGoldRequest(socket, userId, data));
  socket.on('getGoldRequests', () => handleGetGoldRequests(socket, userId));
  socket.on('getSocialRelationships', () => handleGetSocialRelationships(socket, userId));
  socket.on('getTopPlayers', () => handleGetTopPlayers(socket, userId));
  socket.on('listAllSocial', () => handleListAllSocial(socket, userId));
  socket.on('startRecruitSession', (data) => handleStartRecruitSession(socket, userId, data));
  socket.on('endRecruitSession', (data) => handleEndRecruitSession(socket, userId, data));
  socket.on('listRecruitSessions', () => handleListRecruitSessions(socket, userId));
  socket.on('verifyRecruitSession', (data) => handleVerifyRecruitSession(socket, userId, data));
  socket.on('handleRecruitment', (data) => handleRecruitment(socket, userId, data));
  socket.on('getRecruitHistory', () => handleGetRecruitHistory(socket, userId));
  socket.on('autoRecruit', () => handleAutoRecruit(socket, userId));
  socket.on('getRandomRecruitUser', (data) => handleGetRandomRecruitUser(socket, userId, data));
  ...
  socket.on('adminAccountAction', (data) => handleAdminAccountAction(socket, userId, data));
  socket.on('grantPermission', (data) => handleGrantPermission(socket, userId, data));
  ...
  socket.on('accountStatusCron', (data) => handleAccountStatusCron(socket, userId, data));
  socket.on('verifyCaptcha', (data) => handleVerifyCaptcha(socket, userId, data));
  ...
  io = new Server(httpServer, {
    ...
    allowRequest: async (req, callback) => {
      try {
        ...
        const token: any = await getToken({ req: minimalReq as any, secret: process.env.JWT_SECRET });
...
const handleRequestUserData = async (socket: Socket, userId: number) => {
  ...
  try {
    ...
    if (userData.currentStatus === "VACATION") {
      socket.emit('userVacation', serializeData({ ...userData, currentStatus: userData.currentStatus }));
      return;
    }
...
const handleSendMessage = async (socket: Socket, userId: number, data: {
  roomId: number;
  content: string;
  tempId?: number;
  ...
  if (!rateLimiter(`sendMessage-${userId}`, { windowMs: 10000, max: 10 })) {
    socket.emit('messageError', { tempId: data.tempId, error: 'You are sending messages too quickly.' });
    return;
  }
...
const handleAddReaction = async (socket: Socket, userId: number, data: { messageId: number; reaction: string; roomId: number }) => {
  if (!rateLimiter(`addReaction-${userId}`, { windowMs: 10000, max: 20 })) {
    socket.emit('reactionError', { messageId: data.messageId, error: 'You are reacting too quickly.' });
    return;
  }
...
const handleRemoveReaction = async (socket: Socket, userId: number, data: { messageId: number; reaction: string; roomId: number }) => {
  const { messageId, reaction, roomId } = data;
...
const handleMarkAsRead = async (socket: Socket, userId: number, data: { messageId: number; roomId: number } | { messageIds: number[]; roomId: number }) => {
  const { roomId } = data;
...
const handleUpdateBio = async (socket: Socket, userId: number, data: { bio: string }) => {
  try {
    const { bio } = data;
...
const handleUpdateProfile = async (socket: Socket, userId: number, data: { bio?: string; avatarFile?: string }) => {
  try {
...
const handleChangePassword = async (socket: Socket, userId: number, data: { currentPassword: string; newPassword: string; confirmPassword: string }) => {
  try {
    ...
    socket.emit('changePasswordError', { error: error.message || 'Error changing password' });
  }
};

const handleUpdateSettings = async (socket: Socket, userId: number, data: { locale?: string; colorScheme?: string }) => {
  try {
    ...
    socket.emit('updateSettingsError', { error: error.message || 'Error updating settings' });
  }
};

const handleUpdateEmail = async (socket: Socket, userId: number, data: { newEmail: string; password: string; verify: string }) => {
  try {
    ...
    socket.emit('updateEmailSuccess', { message: 'Email updated successfully.' });
  } catch (error: any) {
    logError('Error updating email:', error);
    socket.emit('updateEmailError', { error: error.message || 'Error updating email' });
  }
};
...
const handleEnable2FA = async (socket: Socket, userId: number) => {
  try {
    ...
    socket.emit('enable2FAError', { error: error.message || 'Error enabling 2FA' });
  }
};
...
const handleDisable2FA = async (socket: Socket, userId: number) => {
  try {
    ...
    socket.emit('disable2FAError', { error: error.message || 'Error disabling 2FA' });
  }
};

const handleVerify2FA = async (socket: Socket, userId: number, data: { token: string }) => {
  try {
    const { token } = data;
    ...
    socket.emit('verify2FAError', { error: error.message || 'Error verifying 2FA' });
  }
};
...
const handleStartVacation = async (socket: Socket, userId: number) => {
  try {
    ...
    socket.emit('startVacationError', { error: error.message || 'Error starting vacation' });
  }
};
...
const handleEndVacation = async (socket: Socket, userId: number) => {
  try {
    ...
    socket.emit('endVacationError', { error: error.message || 'Error ending vacation' });
  }
};

const handleRepairAccount = async (socket: Socket, userId: number, data: { repairPoints: number }) => {
  try {
    ...
    socket.emit('repairAccountError', { error: error.message || 'Error repairing account' });
  }
};

const handleResetAccount = async (socket: Socket, userId: number, data: { password: string }) => {
  try {
    ...
    socket.emit('resetAccountError', { error: error.message || 'Error resetting account' });
  }
};
...
const handleUpdateLastActive = async (socket: Socket, userId: number) => {
  try {
    ...
    socket.emit('updateLastActiveError', { error: error.message || 'Error updating last active' });
  }
};

const handleExecuteAttack = async (socket: Socket, userId: number, data: { defenderId: number; turns: number }) => {
  try {
    ...
    socket.emit('executeAttackError', { error: error.message || 'Error executing attack' });
  }
};

const handleGetAttackLogs = async (socket: Socket, userId: number, data: {
  page?: number;
  limit?: number;
  player?: string;
  minPillage?: number;
  ...
  try {
    ...
    socket.emit('getAttackLogsError', { error: error.message || 'Error getting attack logs' });
  }
};
...
const handleGetRecentAttacks = async (socket: Socket, userId: number) => {
  try {
    ...
    socket.emit('getRecentAttacksError', { error: error.message || 'Error getting recent attacks' });
  }
};

const handleGrantAttackLogACL = async (socket: Socket, userId: number, data: { attackLogId: number; roomId: number; participantIds?: number[] }) => {
  try {
    ...
    socket.emit('grantAttackLogACLError', { error: error.message || 'Error granting attack log ACL' });
  }
};

const handleBattleTest = async (socket: Socket, userId: number, data: { defenderId: number; attackerId?: number }) => {
  try {
    const { defenderId, attackerId } = data;
    // Allow admins to specify different attacker
    const actualAttackerId = (userId === 1 || userId === 2) && attackerId ? attackerId : userId;
    ...
    socket.emit('battleTestError', { error: error.message || 'Error running battle test' });
  }
};

const handleFullScaleBattleTest = async (socket: Socket, userId: number, data: { attackerId?: number }) => {
  try {
    ...
    socket.emit('fullScaleBattleTestError', { error: error.message || 'Error running full scale battle test' });
  }
};

const handleRetestAttack = async (socket: Socket, userId: number, data: { attackLogId: number }) => {
  try {
    ...
    socket.emit('retestAttackError', { error: error.message || 'Error retesting attack' });
  }
};

const handleDepositGold = async (socket: Socket, userId: number, data: { depositAmount: string | number }) => {
  try {
    ...
    socket.emit('depositGoldError', { error: error.message || 'Error depositing gold' });
  }
};

const handleWithdrawGold = async (socket: Socket, userId: number, data: { withdrawAmount: string | number }) => {
  try {
    ...
    socket.emit('withdrawGoldError', { error: error.message || 'Error withdrawing gold' });
  }
};
...
const handleGetDeposits = async (socket: Socket, userId: number) => {
  try {
    ...
    socket.emit('getDepositsError', { error: error.message || 'Error getting deposits' });
  }
};

const handleGetBankHistory = async (socket: Socket, userId: number, data: {
  deposits?: boolean;
  withdraws?: boolean;
  war_spoils?: boolean;
  transfers?: boolean;
  ...
  try {
    const { page = 0, limit = 10, deposits, withdraws, war_spoils, transfers, sale, training, economy, recruitment, fortification, daily, friend_transfers } = data;
    const conditions = [];
    ...
    if (transfers) {
      transactionConditions.push({
        ...
        AND: [
          ...
          { NOT: { from_user_account_type: 'HAND', to_user_account_type: 'BANK' } },
          { NOT: { from_user_account_type: 'BANK', to_user_account_type: 'HAND' } },
        ],
      });
    }
    ...
    socket.emit('getBankHistoryError', { error: error.message || 'Error getting bank history' });
  }
};

const handleEquipItem = async (socket: Socket, userId: number, data: { items: any[] }) => {
  try {
    const { items } = data;
    ...
    socket.emit('equipItemError', { error: error.message || 'Error equipping item' });
  }
};

const handleUnequipItem = async (socket: Socket, userId: number, data: { items: any[] }) => {
  try {
    const { items } = data;
    ...
    socket.emit('unequipItemError', { error: error.message || 'Error unequipping item' });
  }
};

const handleHireMercenary = async (socket: Socket, userId: number, data: { unitType: string; level: number; quantity: number }) => {
  try {
    ...
    socket.emit('hireMercenaryError', { error: error.message || 'Error hiring mercenary' });
  }
};

const handleDismissMercenary = async (socket: Socket, userId: number, data: { unitType: string; level: number; quantity: number }) => {
  try {
    ...
    socket.emit('dismissMercenaryError', { error: error.message || 'Error dismissing mercenary' });
  }
};

const handleConvertItem = async (socket: Socket, userId: number, data: { fromItem: string; toItem: string; conversionAmount: number }) => {
  try {
    ...
    socket.emit('convertItemError', { error: error.message || 'Error converting item' });
  }
};

const handleAddFriend = async (socket: Socket, userId: number, data: { friendId: number; relationshipType: 'FRIEND' | 'ENEMY' }) => {
  try {
    ...
    socket.emit('addFriendError', { error: error.message || 'Error adding friend' });
  }
};

const handleRemoveFriend = async (socket: Socket, userId: number, data: { friendId: number; relationshipType: 'FRIEND' | 'ENEMY' }) => {
  try {
    ...
    socket.emit('removeFriendError', { error: error.message || 'Error removing friend' });
  }
};

const handleRespondToFriendRequest = async (socket: Socket, userId: number, data: { requestId: number; action: 'accept' | 'decline' }) => {
  try {
    ...
    socket.emit('respondToFriendRequestError', { error: error.message || 'Error responding to friend request' });
  }
};

const handleGetFriends = async (socket: Socket, userId: number) => {
  try {
    const result = await SocialService.listRelationships(userId, { type: 'FRIEND' });
    socket.emit('getFriendsSuccess', serializeData(result));
  } catch (error: any) {
    logError('Error getting friends:', error);
    socket.emit('getFriendsError', { error: error.message || 'Error getting friends' });
  }
};

const handleTransferGold = async (socket: Socket, userId: number, data: { friendId: number; amount: string | number; notes?: string }) => {
  try {
    ...
    const result = await SocialService.transferGoldToFriend(userId, data.friendId, amount, data.notes);
    socket.emit('transferGoldSuccess', serializeData(result));
  } catch (error: any) {
    logError('Error transferring gold:', error);
    socket.emit('transferGoldError', { error: error.message || 'Error transferring gold' });
  }
};

const handleSendGoldRequest = async (socket: Socket, userId: number, data: { friendId: number; amount: string | number; notes?: string }) => {
  try {
    const amount = parseBigInt(data.amount);
    if (amount === null || amount <= 0) {
    ...
    const result = await SocialService.createGoldRequest(userId, { friendId: data.friendId, amount, notes: data.notes });
    socket.emit('sendGoldRequestSuccess', serializeData(result));
  } catch (error: any) {
    logError('Error sending gold request:', error);
    socket.emit('sendGoldRequestError', { error: error.message || 'Error sending gold request' });
  }
};

const handleRespondToGoldRequest = async (socket: Socket, userId: number, data: { requestId: number; action: 'accept' | 'decline'; message?: string }) => {
  try {
    ...
    socket.emit('respondToGoldRequestError', { error: error.message || 'Error responding to gold request' });
  }
};
...
const handleGetGoldRequests = async (socket: Socket, userId: number) => {
  try {
    ...
    socket.emit('getGoldRequestsError', { error: error.message || 'Error getting gold requests' });
  }
};
...
const handleGetSocialRelationships = async (socket: Socket, userId: number) => {
  try {
    ...
    socket.emit('getSocialRelationshipsError', { error: error.message || 'Error getting social relationships' });
  }
};

const handleGetTopPlayers = async (socket: Socket, userId: number) => {
  try {
    const result = await SocialService.getTopRelationships(userId, { type: 'FRIEND' });
    socket.emit('getTopPlayersSuccess', serializeData(result));
  } catch (error: any) {
    logError('Error getting top players:', error);
    socket.emit('getTopPlayersError', { error: error.message || 'Error getting top players' });
  }
};
...
const handleListAllSocial = async (socket: Socket, userId: number) => {
  try {
    ...
    socket.emit('listAllSocialError', { error: error.message || 'Error listing all social' });
  }
};

const handleStartRecruitSession = async (socket: Socket, userId: number, data: { ipAddress?: string }) => {
  try {
    const result = await createSession(userId);
    socket.emit('startRecruitSessionSuccess', serializeData(result));
  } catch (error: any) {
    logError('Error starting recruit session:', error);
    socket.emit('startRecruitSessionError', { error: error.message || 'Error starting recruit session' });
  }
};

const handleEndRecruitSession = async (socket: Socket, userId: number, data: { sessionId: number }) => {
  try {
    ...
    socket.emit('endRecruitSessionError', { error: error.message || 'Error ending recruit session' });
  }
};
...
const handleListRecruitSessions = async (socket: Socket, userId: number) => {
  try {
    ...
    socket.emit('listRecruitSessionsError', { error: error.message || 'Error listing recruit sessions' });
  }
};

const handleVerifyRecruitSession = async (socket: Socket, userId: number, data: { sessionId: number }) => {
  try {
    ...
    socket.emit('verifyRecruitSessionError', { error: error.message || 'Error verifying recruit session' });
  }
};
...
const handleRecruitment = async (socket: Socket, userId: number, data: any) => {
  try {
    ...
    await logAction(userId || toUser, 'RECRUIT', ipAddress, { recruitedUserId, selfRecruit });

    socket.emit('handleRecruitmentSuccess', serializeData(result));
  } catch (error: any) {
    if (error.name === 'ZodError') {
      socket.emit('handleRecruitmentError', { error: 'Invalid input', details: error.format() });
      return;
    }
...
const handleGetRecruitHistory = async (socket: Socket, userId: number) => {
  try {
    ...
    const usersWithRecruitCount = await getRecruitmentRecords(userId, startDate, endDate);

    if (!usersWithRecruitCount.length) {
      socket.emit('getRecruitHistoryError', { error: 'No recruitment history found in the last 24 hours.', '24hoursago': getOTStartDate() });
      return;
    }

    socket.emit('getRecruitHistorySuccess', serializeData({ usersWithRecruitCount, '24hoursago': getOTStartDate() }));
  } catch (error: any) {
    logError('Error getting recruit history:', error);
    socket.emit('getRecruitHistoryError', { error: error.message || 'Error getting recruit history' });
  }
};
...
const handleAutoRecruit = async (socket: Socket, userId: number) => {
  try {
    ...
    if (!randomUser) {
      socket.emit('autoRecruitError', { error: 'No valid users available for recruitment.' });
      return;
    }

    socket.emit('autoRecruitSuccess', serializeData({ recruit_link: randomUser.recruit_link }));
  } catch (error: any) {
    logError('Error in auto recruit:', error);
    socket.emit('autoRecruitError', { error: error.message || 'Error in auto recruit' });
  }
};

const handleGetRandomRecruitUser = async (socket: Socket, userId: number, data: { sessionId?: number }) => {
  try {
    ...
    if (sessionId) {
      ...
      if (!sessionRecord || sessionRecord.userId !== userId) {
        socket.emit('getRandomRecruitUserError', { error: 'Invalid session ID' });
        return;
      }
    ...
    if (!result || !('usersLeft' in result) || !('activeUsers' in result)) {
      socket.emit('getRandomRecruitUserError', { error: 'Invalid response from recruitment service' });
      return;
    }
    ...
    if (!randomUser) {
      logError('Failed to select a random user even though actuallyRecruitableUsers was not empty.');
      socket.emit('getRandomRecruitUserError', { error: 'Internal error selecting recruitable user.' });
      return;
    }

    socket.emit('getRandomRecruitUserSuccess', serializeData({
      randomUser: {
        ...randomUser.user,
    ...
    socket.emit('getRandomRecruitUserError', { error: error.message || 'Error getting random recruit user' });
  }
};
...
const handleGetChatRooms = async (socket: Socket, userId: number) => {
  try {
    ...
    socket.emit('getChatRoomsError', { error: error.message || 'Error getting chat rooms' });
  }
};

const handleCreateChatRoom = async (socket: Socket, userId: number, data: { name?: string; recipients: number[]; message?: string; isPrivate?: boolean }) => {
  try {
    ...
    socket.emit('createChatRoomError', { error: error.message || 'Error creating chat room' });
  }
};

const handleGetRoomMessages = async (socket: Socket, userId: number, data: { roomId: number }) => {
  try {
    const messages = await MessagingService.getRoomMessages(userId, data.roomId);
    socket.emit('getRoomMessagesSuccess', serializeData(messages));
  } catch (error: any) {
    logError('Error getting room messages:', error);
    socket.emit('getRoomMessagesError', { error: error.message || 'Error getting room messages' });
  }
};

const handleAddParticipants = async (socket: Socket, userId: number, data: { roomId: number; userIds: number[] }) => {
  try {
    const result = await MessagingService.addParticipants(userId, data.roomId, { userIds: data.userIds });
    socket.emit('addParticipantsSuccess', serializeData(result));
  } catch (error: any) {
    logError('Error adding participants:', error);
    socket.emit('addParticipantsError', { error: error.message || 'Error adding participants' });
  }
};

const handleManageParticipant = async (socket: Socket, userId: number, data: { roomId: number; targetUserId: number; action: 'promote' | 'demote' | 'updatePermissions'; canWrite?: boolean }) => {
  try {
    const result = await MessagingService.manageParticipant(userId, data.roomId, data.targetUserId, { action: data.action, canWrite: data.canWrite });
    socket.emit('manageParticipantSuccess', serializeData(result));
  } catch (error: any) {
    logError('Error managing participant:', error);
    socket.emit('manageParticipantError', { error: error.message || 'Error managing participant' });
  }
};

const handleRemoveParticipant = async (socket: Socket, userId: number, data: { roomId: number; targetUserId: number }) => {
  try {
    const result = await MessagingService.removeParticipant(userId, data.roomId, data.targetUserId);
    socket.emit('removeParticipantSuccess', serializeData(result));
  } catch (error: any) {
    logError('Error removing participant:', error);
    socket.emit('removeParticipantError', { error: error.message || 'Error removing participant' });
  }
};

const handleSearchMessages = async (socket: Socket, userId: number, data: { roomId: number; searchTerm?: string; limit?: number; offset?: number; senderId?: number; messageType?: string; startDate?: Date; endDate?: Date }) => {
  try {
    ...
    socket.emit('searchMessagesError', { error: error.message || 'Error searching messages' });
  }
};

const handleTrainUnits = async (socket: Socket, userId: number, data: { userId: number; units: { type: string; level: number; quantity: number }[] }) => {
  try {
    const result = await trainUnits(data);
    socket.emit('trainUnitsSuccess', serializeData(result));
  } catch (error: any) {
    logError('Error training units:', error);
    socket.emit('trainUnitsError', { error: error.message || 'Error training units' });
  }
};

const handleUntrainUnits = async (socket: Socket, userId: number, data: { userId: number; units: { type: string; level: number; quantity: number }[] }) => {
  try {
    ...
    socket.emit('untrainUnitsError', { error: error.message || 'Error untraining units' });
  }
};

const handleConvertUnits = async (socket: Socket, userId: number, data: { userId: number; fromUnit: { type: string; level: number }; toUnit: { type: string; level: number }; conversionAmount: number }) => {
  try {
    ...
    socket.emit('convertUnitsError', { error: error.message || 'Error converting units' });
  }
};

const handleManageStructureUpgrades = async (socket: Socket, userId: number, data: { currentPage: 'fortifications' | 'houses' | 'economy' | 'offense' | 'armory' | 'spy'; index: number }) => {
  try {
    const result = await StructureService.upgradeStructure(userId, { upgradeType: data.currentPage, index: data.index });
    socket.emit('manageStructureUpgradesSuccess', serializeData(result));
  } catch (error: any) {
    logError('Error managing structure upgrades:', error);
    socket.emit('manageStructureUpgradesError', { error: error.message || 'Error managing structure upgrades' });
  }
};

const handleManageBattleUpgrades = async (socket: Socket, userId: number, data: { items: any[]; operation?: 'buy' | 'sell' }) => {
  try {
    const result = await BattleService.manageBattleUpgrades({ userId, items: data.items, operation: data.operation || 'buy' });
    socket.emit('manageBattleUpgradesSuccess', serializeData(result));
  } catch (error: any) {
    logError('Error managing battle upgrades:', error);
    socket.emit('manageBattleUpgradesError', { error: error.message || 'Error managing battle upgrades' });
  }
};

const handleCreateBlogPost = async (socket: Socket, userId: number, data: { title: string; content: string }) => {
  try {
    const result = await BlogService.createPost({ userId, title: data.title, content: data.content });
    socket.emit('createBlogPostSuccess', serializeData(result));
  } catch (error: any) {
    logError('Error creating blog post:', error);
    socket.emit('createBlogPostError', { error: error.message || 'Error creating blog post' });
  }
};
...
const handleGetBlogPosts = async (socket: Socket, userId: number) => {
  try {
    ...
    socket.emit('getBlogPostsError', { error: error.message || 'Error getting blog posts' });
  }
};
...
const handleGetRecentBlogPosts = async (socket: Socket, userId: number) => {
  try {
    ...
    socket.emit('getRecentBlogPostsError', { error: error.message || 'Error getting recent blog posts' });
  }
};

const handleUpdateBlogReadStatus = async (socket: Socket, userId: number, data: { postId: number }) => {
  try {
    const result = await BlogService.updateReadStatus({ userId, postId: data.postId });
    socket.emit('updateBlogReadStatusSuccess', serializeData(result));
  } catch (error: any) {
    logError('Error updating blog read status:', error);
    socket.emit('updateBlogReadStatusError', { error: error.message || 'Error updating blog read status' });
  }
};

const handleGetLatestUnreadBlogPost = async (socket: Socket, userId: number) => {
  try {
    ...
    socket.emit('getLatestUnreadBlogPostError', { error: error.message || 'Error getting latest unread blog post' });
  }
};
...
const handleGetUserData = async (socket: Socket, userId: number) => {
  try {
    ...
    socket.emit('getUserDataError', { error: error.message || 'Error getting user data' });
  }
};

const handleSearchUsers = async (socket: Socket, userId: number, data: { name: string }) => {
  try {
    ...
    socket.emit('searchUsersError', { error: error.message || 'Error searching users' });
  }
};

const handleCheckDisplayName = async (socket: Socket, userId: number, data: { displayName: string }) => {
  try {
    ...
    socket.emit('checkDisplayNameSuccess', serializeData({ exists, possibleMatches }));
  } catch (error: any) {
    logError('Error checking display name:', error);
    socket.emit('checkDisplayNameError', { error: error.message || 'Error checking display name' });
  }
};
...
const handleGetOnlinePlayers = async (socket: Socket, userId: number) => {
  try {
    ...
    const [allUsersCounted, onlineUsers, newUsers, newestUser] = await Promise.all([
      prisma.users.count(),
      prisma.users.count({
        where: {
          last_active: {
    ...
    socket.emit('getOnlinePlayersError', { error: error.message || 'Error getting online players' });
  }
};
...
const handleCompareTop = async (socket: Socket, userId: number) => {
  try {
    ...
    socket.emit('compareTopError', { error: error.message || 'Error comparing top players' });
  }
};
...
const handleResetGame = async (socket: Socket, userId: number) => {
  try {
    ...
    socket.emit('resetGameError', { error: 'Game reset functionality not yet implemented' });
  } catch (error: any) {
    logError('Error resetting game:', error);
    socket.emit('resetGameError', { error: error.message || 'Error resetting game' });
  }
};
...
const handleRevalidate = async (socket: Socket, userId: number) => {
  try {
    ...
    const userData = await UserDataService.getFullUserData(userId);
    socket.emit('revalidateSuccess', serializeData({ userData, message: 'User data revalidated' }));
  } catch (error: any) {
    logError('Error revalidating:', error);
    socket.emit('revalidateError', { error: error.message || 'Error revalidating' });
  }
};
...
const handleGetUserBreakdown = async (socket: Socket, userId: number) => {
  try {
    ...
    socket.emit('getUserBreakdownError', { error: error.message || 'Error getting user breakdown' });
  }
};
...
const handleGetUserStats = async (socket: Socket, userId: number) => {
  try {
    ...
    socket.emit('getUserStatsError', { error: error.message || 'Error getting user stats' });
  }
};

const handleGetUserInfoByRecruitLink = async (socket: Socket, userId: number, data: { recruitLink: string }) => {
  try {
    ...
    socket.emit('getUserInfoByRecruitLinkError', { error: error.message || 'Error getting user info by recruit link' });
  }
};

// --- Phase 4: Administrative & Utility Handlers ---

const handleAdminAccountAction = async (socket: Socket, userId: number, data: { targetUserId: number; action: string; reason?: string }) => {
  try {
    ...
    const result = await AdminService.performAccountAction(userId, accountActionData);
    socket.emit('adminAccountActionSuccess', serializeData(result));
  } catch (error: any) {
    logError('Error in admin account action:', error);
    socket.emit('adminAccountActionError', { error: error.message || 'Error performing admin account action' });
  }
};

const handleGrantPermission = async (socket: Socket, userId: number, data: { targetUserId: number; permission: string }) => {
  try {
    ...
    socket.emit('grantPermissionError', { error: error.message || 'Error granting permission' });
  }
};
...
const handleStartEra = async (socket: Socket, userId: number) => {
  try {
    ...
    socket.emit('startEraError', { error: error.message || 'Error starting new era' });
  }
};
...
const handleGetConstants = async (socket: Socket, userId: number) => {
  try {
    ...
    const { EconomyUpgrades, OffensiveUpgrades, SentryUpgrades, SpyUpgrades } = await import('@/constants/Structure_Upgrades');
    ...
    socket.emit('getConstantsError', { error: error.message || 'Error getting constants' });
  }
};
...
const handleGetRankBreakdown = async (socket: Socket, userId: number) => {
  try {
    ...
    const userRanks = allUsers.map((user) => {
      const userModel = new UserModel(user, user.UserUnit, user.UserItem, user.UserStructureUpgrade, user.UserBattleUpgrade, user.UserBonusPoints, user.permissions.map(p => ({ type: p })), user.stats);
    ...
    socket.emit('getRankBreakdownError', { error: error.message || 'Error getting rank breakdown' });
  }
};

const handleDailyCron = async (socket: Socket, userId: number, data: { authToken: string }) => {
  try {
    ...
    if (!user || !user.permissions.some(p => p === 'ADMINISTRATOR')) {
      socket.emit('dailyCronError', { error: 'Unauthorized: Administrator access required' });
      return;
    }
    ...
    socket.emit('dailyCronError', { error: error.message || 'Error running daily cron' });
  }
};

const handleTurnsCron = async (socket: Socket, userId: number, data: { authToken: string }) => {
  try {
    // Verify admin authorization
    const user = await prisma.users.findUnique({
      where: { id: userId },
    ...
    if (!user || !user.permissions.some(p => p === 'ADMINISTRATOR')) {
      socket.emit('turnsCronError', { error: 'Unauthorized: Administrator access required' });
      return;
    }
    ...
    socket.emit('turnsCronError', { error: error.message || 'Error running turns cron' });
  }
};

const handleAccountStatusCron = async (socket: Socket, userId: number, data: { authToken: string }) => {
  try {
    // Verify admin authorization
    const user = await prisma.users.findUnique({
      where: { id: userId },
    ...
    if (!user || !user.permissions.some(p => p === 'ADMINISTRATOR')) {
      socket.emit('accountStatusCronError', { error: 'Unauthorized: Administrator access required' });
      return;
    }
    ...
    socket.emit('accountStatusCronError', { error: error.message || 'Error running account status cron' });
  }
};

const handleVerifyCaptcha = async (socket: Socket, userId: number, data: { token: string }) => {
  try {
    ...
    socket.emit('verifyCaptchaError', { error: error.message || 'Error verifying captcha' });
  }
};
...
const handleNotifyEnemyDeclaration = async ({ userId: targetUserId, message }) => {
  const hash = md5(message + targetUserId);

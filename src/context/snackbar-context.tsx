          ...
          (
            ...
            return (
              <motion.div
                ...
                className={`relative w-full rounded-lg p-0 text-sm font-medium shadow-lg ${styles.borderColor} shadow-lg transition-all duration-300 ease-in-out hover:shadow-xl`}
                style={{
                  borderWidth: '2px',
              ...
              >
                <div
                  className={`flex items-center gap-3 p-4 ${styles.bgColor}`}
                >
                  <span className={`shrink-0 ${styles.iconColor}`}>
                    {styles.icon}
                  </span>

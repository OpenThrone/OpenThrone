...
const Stats = ({ attacks, recruits, population, totalWealth, goldOnHand, goldInBank, lastGenerated }: InferGetStaticPropsType<typeof getStaticProps>) => {
  return (
    <>
      <div className="container mx-auto p-4">
        <h2 className="mb-4 text-2xl font-bold">Community Stats</h2>
        <p>Last generated: {new Date(lastGenerated).toLocaleString()}</p>
      </div>

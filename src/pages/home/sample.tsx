    ...
    <MainArea title="Theme Sample">
      <div style={{ padding: '2rem' }}>
        ...
        >
          ...
          <Text ta="center">
            This is a card component to show off the brand and secondary colors
        ...
        <Center>
          <Table highlightOnHover>
            ...
            <tbody>
              ...
              <tr>
                <td>Light Mode</td>
                <td style={{ color: theme.colors.secondary[6] }}>X</td>
              </tr>
            </tbody>
          </Table>
        </Center>
        ...
        <Group align="center">
          ...
          >
            ...
            <Space h="md" />
            <Center>{renderColorSquares(theme.colors.brand.slice(1))}</Center>
          </Card>
        </Group>
        <Space h="md" />
        <Group align="center">

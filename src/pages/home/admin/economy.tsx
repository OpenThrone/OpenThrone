...
interface EconomyStats {
  ...
  avgBankGold: number;
  topHolders: Array<{ id: number; display_name: string; gold: string; bank: string; net: string }>;
...
const EconomyPage = () => {
  ...
  if (loading || !stats) {
    return (
      <MainArea title="Economy Dashboard">
  ...
  return (
    <PermissionCheck permissions={['VIEW_ECONOMY']}>
      <MainArea title="Economy Overview">
        <Stack gap="md">
          <GameCard title="Gold in Circulation">
            <Grid>
              ...
              <Grid.Col span={{ base: 12, sm: 4 }}>
                <Paper p="md" withBorder>
                  <FontAwesomeIcon icon={faMoneyBillWave} size="2x" color="#22c55e" />
                  <Text size="xs" tt="uppercase" c="dimmed" fw={700} mt="sm">
                    Total Economy
                  </Text>
                  <Text size="xl" fw={900}>
            ...
            <Grid>
              ...
              <Grid.Col span={{ base: 12, sm: 4 }}>
                <Paper p="md" withBorder>
                  ...
                  <Text size="lg" fw={700}>
                    {stats.transfersLast24h} ({formatNum(stats.transferVolume24h)} gold)
                  </Text>
                </Paper>
              </Grid.Col>
            </Grid>

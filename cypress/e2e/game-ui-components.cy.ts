...
describe('Game UI Components', () => {
  ...
  describe('GameCard Component', () => {
    ...
    it('should apply race-specific gradient to GameCard header', () => {
      ...
      cy.get('[data-testid="game-card-header"]').should('have.css', 'background-image').and('match', /gradient/);
      cy.get('[data-testid="game-card-header"]').should('have.css', 'background-image').and('include', 'rgb(34, 139, 34)');
    ...
    it('should handle GameCard hover states', () => {
      ...
      cy.get('[data-testid="game-card"]').first().invoke('css', 'transform').should('not.eq', 'none');
    });
  ...
  describe('StatGrid Component', () => {
    ...
    it('should display stat values correctly in slots', () => {
      ...
      cy.get('[data-testid="stat-slot"]').first().within(() => {
    ...
    it('should apply gold accent to stat values', () => {
      ...
      cy.get('[data-testid="stat-value"]').first().should('have.css', 'color').and('match', /rgb\(255,\s*215,\s*0\)|rgb\(255,\s*193,\s*7\)/);
  ...
  describe('WarlordTable Component', () => {
    ...
    it('should handle WarlordTable row hover states', () => {
      ...
      cy.get('[data-testid="table-row"]').first().should('have.css', 'background-color');
    });
  ...
  describe('StyledTable Component', () => {
    it('should render StyledTable with proper styling', () => {
      ...
      cy.get('[data-testid="styled-table"]').should('have.css', 'border-collapse').and('equal', 'collapse');
    ...
    it('should handle StyledTable mobile view', () => {
      ...
      cy.get('[data-testid="table-wrapper"]').should('have.css', 'overflow-x').and('match', /auto|scroll/);
    ...
    it('should display StyledTable with alternating row colors', () => {
      ...
      cy.get('[data-testid="table-row"]').eq(0).should('have.css', 'background-color');
      cy.get('[data-testid="table-row"]').eq(1).should('have.css', 'background-color');
  ...
  describe('Entry Animations (public-rise)', () => {
    it('should apply public-rise animation to cards', () => {
      ...
      cy.get('[data-testid="game-card"]').first().should('have.css', 'animation-name').and('equal', 'public-rise');
    ...
    it('should respect reduced motion preference', () => {
      ...
      cy.get('[data-testid="game-card"]').first().should('have.css', 'animation-name').and('equal', 'none');
  ...
  describe('Component Integration', () => {
    ...
    it('should maintain consistent styling across components', () => {
      ...
      const components = ['[data-testid="game-card"]', '[data-testid="stat-grid"]'];
